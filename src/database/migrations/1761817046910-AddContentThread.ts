...
export class AddContentThread1761817046910 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "threads" ADD "content" text NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."attendance_status_enum_old" AS ENUM('PRESENT', 'ABSENT', 'LATE', 'EXCUSED')`,
    );
    await queryRunner.query(
      `ALTER TABLE "attendance" ALTER COLUMN "status" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "attendance" ALTER COLUMN "status" TYPE "public"."attendance_status_enum_old" USING "status"::"text"::"public"."attendance_status_enum_old"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."attendance_status_enum_old" RENAME TO "attendance_status_enum"`,
    );
